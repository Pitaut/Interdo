-- ============================================================================
-- Migration 011: Recréation de la vue v_rentabilite_interventions sans DEFINER
-- But: éviter les erreurs d'import sur serveurs où `root@localhost` n'existe pas.
-- ============================================================================

DROP VIEW IF EXISTS v_rentabilite_interventions;
